...
def get_indices_of_item_weights(weights, length, limit):
    ...
    """
    find the items whose sum of weights == limit 
    return an Answer tuple where each element represents the item weights of the 2 packages, like (Higher, Lower). If there is no pair, return None 
    """  
